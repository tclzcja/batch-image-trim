...
const files = (await fs.promises.readdir(CURRENT_DIRECTORY)).filter((f) => [".png", ".bmp", ".tiff"].includes(path.extname(f)));
...
for (const f of files) {
	...
	image.crop(edgeLeft, edgeTop, edgeRight - edgeLeft + 1, edgeBottom - edgeTop + 1);
